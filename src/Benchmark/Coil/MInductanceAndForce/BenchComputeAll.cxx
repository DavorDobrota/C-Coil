...
void benchCoilMInductanceAndForceComputeAllMTvsMTD(PrecisionFactor precisionFactor, int threadCount)
{
...
void benchCoilMInductanceAndForceComputeAllGPU(int configCount)
{
    using namespace std::chrono;
...
void benchCoilMInductanceAndForceComputeAll(int configCount, int threadCount)
{
    using namespace std::chrono;
