...
void initBenchmark(py::module_ &mainModule)
{
    ...
    benchmarkModule.def(
            "force_Z_axis", &Benchmark::forceZAxis,
            py::arg("compute_method") = CPU_ST, py::arg("thread_count") = g_defaultThreadCount)
        .def(
            "force_Z_axis_MT_scaling", &Benchmark::forceZAxisMTScaling,
            py::arg("max_thread_count") = g_defaultThreadCount);
    ...
    benchmarkModule.def(
        ...
        .def(
            "coil_group_compute_all_fields_MT_scaling", &Benchmark::coilGroupComputeAllFieldsMTScaling,
            py::arg("precision_factor") = PrecisionFactor(), py::arg("thread_count") = g_defaultThreadCount,
            py::arg("coil_count") = 100, py::arg("max_points_log_2") = g_maxPotGroup)
        .def(
            "coil_group_compute_all_fields_GPU_scaling", &Benchmark::coilGroupComputeAllFieldsGPUScaling,
            py::arg("precision_factor") = PrecisionFactor(),
            py::arg("coil_count") = 100, py::arg("max_points_log_2") = g_maxPotGroup)
        .def(
