...
__global__
void CalculateMutualInductanceConfigurations(long long numConfigs, long long numPoints, CoilPairArgumentsData coilPair,
                                                ...
                                                TYPE *inductanceArr)
{
    ...
    if(inductanceArr != nullptr)
        gpuErrchk(cudaMemcpy(inductanceArr, g_inductanceArr, numConfigs * sizeof(TYPE), cudaMemcpyDeviceToHost))
