...
void initCoilData(py::module_ &mainModule)
{
    ...
    coilData.def_readwrite("current_density", &CoilData::constFactor)
            ...
            .def_readwrite("angular_iterations", &CoilData::angularIncrements)
            .def_readwrite("length_iterations", &CoilData::lengthIncrements)
