...
void testAmpereForceGeneralForZAxis()
{
    ...
    prim.setPositionAndOrientation(vec3::Vector3(0.1, 0.0, 0.0));
...
void testGradientTensor()
{
    ...
    {
        tensor = coil.computeBGradientMatrix(vec3::Vector3::getFromCylindricalCoords(0.001 * i, 0.0, 0.0));
    ...
    for (int i = 0; i < 1000; ++i)
    {
        tensor = coil.computeBGradientMatrix(vec3::Vector3::getFromCylindricalCoords(i * 0.001, 0.5, M_PI / 4));
