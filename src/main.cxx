...
//    testPerformanceForComputeAll(PrecisionFactor(6.0), 50000, 5, 2);
//    testPerformanceForComputeAll(PrecisionFactor(6.0), 50000, 5, 3);
//    testPerformanceForComputeAll(PrecisionFactor(6.0), 50000, 5, 4);
//    testPerformanceForComputeAll(PrecisionFactor(6.0), 50000, 5, 5);
//    testPerformanceForComputeAll(PrecisionFactor(6.0), 50000, 5, 6);
//    testPerformanceForComputeAll(PrecisionFactor(6.0), 50000, 5, 7);
//    testPerformanceForComputeAll(PrecisionFactor(6.0), 50000, 5, 8);
